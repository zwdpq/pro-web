...
public class FruitDaoImpl  extends BaseDao<Fruit> implements FruitDao{
    ...
    @Override
    public List<Fruit> getFruitsByPageNo(Integer pageStart,String keyword) {
        return super.executeQuery("select * from t_fruit where fname like ? or remark like ? limit ?,5", "%"+ keyword +"%","%"+ keyword +"%",pageStart);
    }
}
