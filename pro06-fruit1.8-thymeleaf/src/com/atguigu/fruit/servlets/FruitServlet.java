    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (operate) {
            case "index": index(req,resp);
                break;
            case "addFruit": addFruit(req,resp);
                break;
            case "delFruit": delFruit(req,resp);
                break;
            case "editFruit": editFruit(req,resp);
                break;
            case "updateFruit": updateFruit(req,resp);
                break;
                default: throw new RuntimeException("operate参数无效或有错");
        }
    }
